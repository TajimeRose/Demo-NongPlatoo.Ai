...
6. ตอบคำถามให้ครบถ้วน ละเอียด สมบูรณ์ ไม่ตัดจบกลางคัน หรือค้างข้อความไว้ ให้ตอบจนจบประเด็นทั้งหมดอย่างครบถ้วน
7. ตอบในรูปแบบ Markdown ที่เป็นทางการ สะอาดตา อ่านง่าย มีหัวข้อย่อยชัดเจน และห้ามมีอิโมจิในข้อความ`;
};
